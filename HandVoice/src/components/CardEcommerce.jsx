        ...
        <div className="dark:bg-darksblue">
            {isMobile ? (
                <div className="flex justify-center items-center flex-col bg-neutral-50 dark:bg-darksblue">
                    <img className="dark:bg-transparent dark:shadow-none m-3 bg-white p-5  shadow-[4px_4px_4px_0px_rgba(0,0,0,0.25)] w-[545px] h-[450px] rounded-[10px]" src={EcommerceImageHand} alt="" />
